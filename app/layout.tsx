...
export const metadata: Metadata = {
  title: "Ziro",
  description:
    "Ziro is the open-source interface for AI chat. Multi-model, BYOK-ready, and fully self-hostable. Use Claude, OpenAI, Gemini, local models, and more, all in one place.",
